...
Usado y adaptado por Sergio Pedroza
...
#Main
path = r"C:\Users\Tato Pedroza\Downloads\semena-tec-tools-vision-master\semena-tec-tools-vision-master\Images\Convolution.jpeg"
image = cv2.imread(path)
print(image)
gray = cv2.cvtColor(image,cv2.COLOR_BGR2GRAY)
cv2.imshow('image', gray)
kernel = np.ones((3,3)) # Filtro estándar
